...
def logs_page1(logs_df, staff_df, start_date, end_date):
    ...
    if not filtered_logs.empty:
        ...
        with col1_g:
            ...
            if 'Date_d_création' in logs_per_period.columns:
        ...
        with col2_g:
            ...
            if 'Heure_création' in filtered_logs.columns:
                try:
                    # Attempt to parse as HH:MM:SS.fff
